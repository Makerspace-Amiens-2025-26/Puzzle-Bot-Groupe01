...
Une fois l’assemblage de la machine terminé, plusieurs contrôles ont été réalisés afin de garantir son bon fonctionnement global et de valider les améliorations apportées lors de la phase de finition.
